...
const std::vector<SpawnEvent> s_Stage02Wave = {
    {2000.0f, "gopro", 150.0f, 0.0007f},
    {5000.0f, "gopro", 150.0f, 0.0007f},
    {7000.0f, "gopro", 150.0f, 0.0007f},
    {12000.0f, "bigbo", 400.0f, 0.00035f},
    {14000.0f, "gopro", 170.0f, 0.00077f},
    {16000.0f, "gopro", 170.0f, 0.00077f},
    {16000.0f, "gopro", 170.0f, 0.00077f},
    {22000.0f, "trslim", 100.0f, 0.00126f},
    {23000.0f, "trslim", 100.0f, 0.00126f},
    {24000.0f, "trslim", 100.0f, 0.00126f},
    {25000.0f, "trslim", 100.0f, 0.00126f},
    {32000.0f, "bigbo", 500.0f, 0.00028f},
    {33000.0f, "trslim", 120.0f, 0.00105f},
    {34000.0f, "trslim", 120.0f, 0.00105f},
    {37000.0f, "bigbo", 500.0f, 0.00028f},
    {45000.0f, "bigbo", 1200.0f, 0.00021f},
    {46000.0f, "trslim", 150.0f, 0.0014f},
    {47000.0f, "trslim", 150.0f, 0.0014f},
    {48000.0f, "trslim", 150.0f, 0.0014f},
    {49000.0f, "trslim", 150.0f, 0.0014f},
};

const std::vector<SpawnEvent> s_Stage03Wave = {
    // Wave 1: trslim * 3
    { 2000.0f, "trslim", 100.0f, 0.00126f},
    { 3000.0f, "trslim", 100.0f, 0.00126f},
    { 4000.0f, "trslim", 100.0f, 0.00126f},

    // Wave 2: trslim * 4 + bigbo * 2
    { 9000.0f, "trslim", 110.0f, 0.00126f},
    {11000.0f, "trslim", 110.0f, 0.00126f},
    {13000.0f, "trslim", 110.0f, 0.00126f},
    {14000.0f, "trslim", 110.0f, 0.00126f},
    {11500.0f, "bigbo",  420.0f, 0.00035f},
    {14500.0f, "bigbo",  420.0f, 0.00035f},

    // Wave 3: trslim * 4 + bigbo * 3 + yokai * 1
    {20000.0f, "trslim", 120.0f, 0.00133f},
    {21000.0f, "trslim", 120.0f, 0.00133f},
    {22000.0f, "trslim", 120.0f, 0.00133f},
    {23000.0f, "trslim", 120.0f, 0.00133f},
    {19500.0f, "bigbo",  520.0f, 0.00028f},
    {21500.0f, "bigbo",  520.0f, 0.00028f},
    {23500.0f, "bigbo",  520.0f, 0.00028f},
    {20500.0f, "yokai",  360.0f, 0.00084f},

    // Wave 4: trslim * 4 + gopro * 3 + yokai * 1
    {31000.0f, "trslim", 140.0f, 0.00140f},
    {32000.0f, "trslim", 140.0f, 0.00140f},
    {33000.0f, "trslim", 140.0f, 0.00140f},
    {34000.0f, "trslim", 140.0f, 0.00140f},
    {30500.0f, "gopro",  170.0f, 0.00077f},
    {32500.0f, "gopro",  170.0f, 0.00077f},
    {33500.0f, "gopro",  170.0f, 0.00077f},
    {30000.0f, "yokai",  420.0f, 0.00091f},

    // Wave 5: yokai focus
    {40000.0f, "yokai",  480.0f, 0.00098f},
    {46000.0f, "bigbo",  650.0f, 0.00028f},
};
...
const std::vector<SpawnEvent> s_Stage04Wave = {
    ...
    { 5000.0f, "trslim", 100.0f, 0.00126f},
    { 5500.0f, "trslim", 100.0f, 0.00126f},
